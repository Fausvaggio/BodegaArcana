  ...
  var ListViewHeaderRow = class extends BaseComponent {
    ...
    render() {
      ...
      return y(ContentContainer, {
        ...
        }, renderProps, generatorName: "dayHeaderContent", customGenerator: options.dayHeaderContent, defaultGenerator: renderInnerContent, classNameGenerator: options.dayHeaderClassNames, didMount: options.dayHeaderDidMount, willUnmount: options.dayHeaderWillUnmount
      }, (InnerContent) => (
  ...
  var ListViewEventRow = class extends BaseComponent {
    render() {
      ...
      return y(EventContainer, Object.assign({}, props, {
        ...
        ], defaultGenerator: () => renderEventInnerContent(seg, context), seg, timeText: "", disableDragging: true, disableResizing: true

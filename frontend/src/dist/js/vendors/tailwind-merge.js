(() => {
  ...
  var tailwind_merge_exports = {};
  __export(tailwind_merge_exports, {
  ...
  var { twMerge: twMerge2 } = tailwind_merge_exports;
  document.querySelectorAll("[data-tw-merge]").forEach((el) => {
    el.setAttribute("class", twMerge2(el.getAttribute("class")));
    el.removeAttribute("data-tw-merge");
  });
  window.twMerge = tailwind_merge_exports;
})();
